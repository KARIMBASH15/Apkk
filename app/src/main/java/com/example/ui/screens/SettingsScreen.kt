...
fun SettingsScreen(
    ...
    val toneOptions = listOf(
        Triple("default", "🔔 جرس تنبيه عادي", "نغمة صافرة تنبيه كلاسيكية متكررة ومسموعة"),
        Triple("chime", "🚚 نغمة التوصيل السريعة", "نغمة ناعمة مزدوجة لسيارة التوصيل"),
        Triple("siren", "⚡ إنذار طوارئ مرتفع", "نغمة إنذار متسارعة وقوية للطلبات المستعجلة"),
        Triple("soft", "🎵 نغمة هادئة وناعمة", "نغمة مريحة وخفيفة مع تكرار بطيء"),
        Triple("triple", "🔊 تنبيه ثلاثي متكرر", "3 دقات متتالية ذات صدى ووضوح عالٍ")
    )
